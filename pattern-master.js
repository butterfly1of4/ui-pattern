...
console.log(item)
var listValue = document.getElementsByClassName('listItem').value
...
// let onMenu = document.getElementsByClassName("menuItem")
// console.log(onMenu)
...
//     if(onMenu.value === i){
//       if (onMenu.classList.contains("visible")) {
//         onMenu.classList.remove("visible")
//         console.log("removed")
//       }
//     }
//     console.log("menu")
